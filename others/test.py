...
def analyzer_test():
    ...
    # analyzer.analyze_class(classname='AMapSearchAPI')
    ...
    # analyzer.analyze_function(0x1007934A0)
    # analyzer.analyze_function(0x100717e14)
    # analyzer.analyze_function(0x10078a0e0)
    # analyzer.analyze_function(0x010065945C)
    analyzer.analyze_function(0x1006594F0)
    # analyzer.analyze_function(0x0100658308)
